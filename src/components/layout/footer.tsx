  ...
  return (
    ...
    <footer className="w-full text-white">
        ...
        <div className="container py-16 relative z-10">
          <div className="grid gap-12 lg:grid-cols-3 items-start">
            ...
            <div className="space-y-6">
              ...
              <p className="text-[#9B2242] text-base leading-relaxed max-w-sm">
            ...
            <div className="flex flex-col items-center space-y-6">
              <h3 className="text-lg font-semibold text-[#9B2242]">Quick Links</h3>
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-center gap-4 text-sm text-[#9B2242]">
                <Link href="#" className="flex items-center gap-2 text-[#9B2242] hover:text-[#7f1b36] hover:underline underline-offset-4 decoration-[#9B2242] transition-all duration-300 hover:scale-105">
                  <Info className="w-4 h-4" />
                  About
                </Link>
                <span className="hidden sm:block text-[#9B2242]/40">•</span>
                <Link href="#" className="flex items-center gap-2 text-[#9B2242] hover:text-[#7f1b36] hover:underline underline-offset-4 decoration-[#9B2242] transition-all duration-300 hover:scale-105">
                ...
                <span className="hidden sm:block text-[#9B2242]/40">•</span>
                <Link href="/privacy" className="flex items-center gap-2 text-[#9B2242] hover:text-[#7f1b36] hover:underline underline-offset-4 decoration-[#9B2242] transition-all duration-300 hover:scale-105">
                  <Shield className="w-4 h-4" />
                  Privacy
                </Link>
                <span className="hidden sm:block text-[#9B2242]/40">•</span>
                <Link href="/terms" className="flex items-center gap-2 text-[#9B2242] hover:text-[#7f1b36] hover:underline underline-offset-4 decoration-[#9B2242] transition-all duration-300 hover:scale-105">
            ...
            <div className="flex flex-col items-center lg:items-end space-y-4">
              <h3 className="text-lg font-semibold text-[#9B2242]">Connect With Us</h3>
              <div className="flex items-center gap-4">
                <Link href="#" className="group inline-flex h-11 w-11 items-center justify-center rounded-full bg-white/10 hover:bg-gradient-to-r hover:from-brand-rose hover:to-brand-blue ring-1 ring-white/20 hover:ring-brand-rose/60 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-brand-rose/25">
                  <Facebook className="h-5 w-5 text-[#9B2242] group-hover:text-white transition-colors" />
                </Link>
                <Link href="#" className="group inline-flex h-11 w-11 items-center justify-center rounded-full bg-white/10 hover:bg-gradient-to-r hover:from-brand-rose hover:to-brand-blue ring-1 ring-white/20 hover:ring-brand-rose/60 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-brand-rose/25">
                  <Instagram className="h-5 w-5 text-[#9B2242] group-hover:text-white transition-colors" />
                </Link>
                <Link href="#" className="group inline-flex h-11 w-11 items-center justify-center rounded-full bg-white/10 hover:bg-gradient-to-r hover:from-brand-rose hover:to-brand-blue ring-1 ring-white/20 hover:ring-brand-rose/60 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-brand-rose/25">
                  <Twitter className="h-5 w-5 text-[#9B2242] group-hover:text-white transition-colors" />
                </Link>
              </div>
            </div>
          </div>
      ...
      <div className="border-t border-[#9B2242]/20 bg-[#0b3a86] relative overflow-hidden">
        ...
        <div className="container flex flex-col sm:flex-row items-center justify-between py-6 text-sm text-[#9B2242] gap-4 relative z-10">
