...
const COPY = {
  id: {
    ...
    works: {
      ...
      head: "Sistem itu, dari awal hingga khitbah.",
  ...
  en: {
    ...
    works: {
      ...
      head: "That system, from the first message to khitbah.",
